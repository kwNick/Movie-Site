    ...
    return (
        <div className='flex flex-col text-gray-300'>
            {Array.map((item: item) => (
                ...
                gap-x-3 hover:border-b-white group'>
         ...
         md:grid-cols-2 lg:grid-cols-4 gap-10'>
            <div>
                ...
                <p className='text-gray-200 text-sm leading-6 tracking-wide mt-5 max-w-72'>
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Debitis vero totam quam inventore, magnam accusamus nihil ipsa eum accusantium voluptatem nobis sint laboriosam reprehenderit amet minus, ipsum mollitia soluta tempore.
                </p>
            </div>
            <div>
                <h2 className='text-base uppercase font-bold text-white
                tracking-wide border-b border-b-gray-600 py-2 mb-5 relative'>
                    Information <span className='w-16 h-1 bg-red-600 inline-block absolute left-0
                    -bottom-[1.5px] z-10'/>
                </h2>
                <Information Array={infoArray} />
            </div>
            <div>
                <h2 className='text-base uppercase font-bold text-white
                tracking-wide border-b border-b-gray-600 py-2 mb-5 relative'>
                    Category <span className='w-16 h-1 bg-red-600 inline-block absolute left-0
                    -bottom-[1.5px] z-10'/>
                </h2>
                <Information Array={categoryArray} />
            </div>
            <div>
                <h2 className='text-base uppercase font-bold text-white
                tracking-wide border-b border-b-gray-600 py-2 mb-5 relative'>
                    Connect With Us <span className='w-16 h-1 bg-red-600 inline-block absolute left-0
                    -bottom-[1.5px] z-10'/>
                </h2>
                <div className='text-gray-300 text-sm flex flex-col gap-2'>
                    <p>
                        Phone: <span className='text-white font-medium'>001 7728 2269</span>
                    </p>
                    <p>
                        Email: <span className='text-white font-medium'>kwnp17c@gmail.com</span>
                    </p>
                </div>
            </div>
        </div>
